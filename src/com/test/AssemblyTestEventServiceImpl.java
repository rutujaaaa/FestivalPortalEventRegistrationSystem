...
public class AssemblyTestEventServiceImpl {
	...
	public void testGetEventCoordinator() {
		...
		assertEquals(eventCoordinatorList.size() > 0, true);
	}
	...
	public void testGetEvent() {		
		try {
			...
			assertEquals(event.getEventid(), daoEvent.getEventid());
		} catch(Exception e){
			fail("Exception");
		}		
	}
	...
	public void testUpdateEvent() {
		...
		try {			
			...
			assertEquals(updateEvent.getEventid(), daoEvent.getEventid());
