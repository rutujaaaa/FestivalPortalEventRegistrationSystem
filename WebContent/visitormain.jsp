				...
				<tr>
					...
					<table cellpadding="5" width="100%">
						<tr>
							...
							<h3>Festival Event Portal Page: Welcome <span style="background-color: yellow;"><jstlcore:out value="${visitor.firstName}"></jstlcore:out></span> to your portal page.....</h3>
							</div>							
